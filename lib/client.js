...
function LineTrend(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "dsh_usage_line", viewBox: `0 0 ${chartW} ${chartH}`, role: "img", "aria-label": "usage trend line", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polygon", { className: "dsh_usage_lineArea", points: `${padL},${chartH - padB} ${linePts.join(" ")} ${chartW - padR},${chartH - padB}` }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("polyline", { className: "dsh_usage_linePath", points: linePts.join(" "), fill: "none" }),
    vals.map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { className: "dsh_usage_lineDot", cx: px(i), cy: py(v), r: "3.5" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: `${data[i].label}: ${intfmt(v)}` })
    ] }, i)),
    data.map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { className: "dsh_usage_trendLabel", x: px(i), y: chartH - 8, textAnchor: "middle", children: d.label }, d.label))
  ] });
}
