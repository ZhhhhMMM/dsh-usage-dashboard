...
// ../../deepseek-harness/plugins/dsh-usage-dashboard/src/client/index.ts
var index_exports = {};
...
// ../../deepseek-harness/plugins/dsh-usage-dashboard/src/client/DashboardSection.tsx
var import_react = require("react");
var import_react_dom = require("react-dom");

// ../../deepseek-harness/plugins/dsh-usage-dashboard/src/client/usage.ts
...
function MultiTrend(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "dsh_usage_trend", viewBox: `0 0 ${chartW} 160`, role: "img", "aria-label": "usage trend", children: [
    data.map((d, i) => {
      const x = i * (barW + gap);
      let acc = 0;
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
        series.map((sr, si) => {
          ...
          const y = 136 - acc - h;
          acc += h;
          return h > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("rect", { className: "dsh_usage_trendBar", x, y, width: barW, height: Math.max(1, h), rx: 1.5, fill: seriesColors[si % seriesColors.length] }, sr.key) : null;
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("text", { className: "dsh_usage_trendLabel", x: x + barW / 2, y: 150, textAnchor: "middle", children: d.label }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: `${d.label}: ${intfmt(series.reduce((s, sr) => s + d[sr.key], 0))}` })
      ] }, d.label);
    }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("line", { className: "dsh_usage_trendAxis", x1: "0", y1: "136", x2: chartW, y2: "136" })
  ] });
}
function Legend(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_usage_legend", children: items.map((it) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh_usage_legendItem", children: [
...
function DetailRow(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", { className: "dsh_usage_detailRow", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { colSpan: 8, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_usage_detailGrid", children: rows.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_usage_detailItem", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_detailLabel", children: row.label }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_detailValue", children: row.value })
  ] }, row.label)) }) }) });
}
function FragmentedRow(props) {
...
function DashboardBody(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_usage_cards", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh_usage_trendCard", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MultiTrend, { data: dailySeries(d.rows, range), series }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Legend, { t })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh_usage_tableWrap", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", { className: "dsh_usage_table", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "dsh_usage_expandCol", children: "" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: t("sessionTitle") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "dsh_usage_num", children: t("colTokens") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "dsh_usage_num", children: t("colCache") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "dsh_usage_num", children: t("colTurns") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "dsh_usage_num", children: t("colSteps") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { className: "dsh_usage_num", children: t("colLlm") }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("th", { children: "" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: d.rows.map((r) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FragmentedRow, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", { className: `dsh_usage_row ${open ? "dsh_usage_rowOpen" : ""}`, onClick: () => {
            toggle(r.sessionId);
          }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "dsh_usage_expandCol", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_expandIcon", children: open ? "\u2212" : "+" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", { className: "dsh_usage_titleCell", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_sessTitle", title: r.cwd ?? "", children: r.title }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh_usage_sessMeta", children: r.origin === "subagent" ? "subagent" : r.cwd ?? "" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "dsh_usage_num", children: unit(tot) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("td", { className: "dsh_usage_num", children: [
              hitRate,
              "%"
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "dsh_usage_num", children: r.stats.turns }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "dsh_usage_num", children: r.stats.steps }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "dsh_usage_num", children: msfmt(r.stats.llmMs) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", { className: "dsh_usage_status", children: r.running ? t("running") : t("finished") })
          ] }),
          open ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DetailRow, { r, t }) : null
        ] }, r.sessionId);
      }) })
    ] }) })
  ] });
...
// ../../deepseek-harness/plugins/dsh-usage-dashboard/src/client/locales.ts
...
// ../../deepseek-harness/plugins/dsh-usage-dashboard/src/client/styles.ts
var css = `
...
.dsh_usage_trend{width:100%;max-width:720px;display:block}
...
//# sourceMappingURL=.tmp-usage-client.js.map
