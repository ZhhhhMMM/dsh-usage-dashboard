...
function LineTrend(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", { className: "dsh_usage_line", viewBox: `0 0 ${chartW} ${chartH}`, role: "img", "aria-label": "usage trend line", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("linearGradient", { id: "dsh_usage_areaGrad", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "0%", stopColor: "var(--dsw-alias-state-business-primary)", stopOpacity: "0.32" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("stop", { offset: "100%", stopColor: "var(--dsw-alias-state-business-primary)", stopOpacity: "0" })
    ] }) }),
    ...
    pts.map((p, i) => i < lastIdx ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { className: "dsh_usage_lineDot", cx: p.x, cy: p.y, r: "2.6" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: `${data[i].label}: ${intfmt(vals[i])}` })
    ] }, i) : null),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { className: "dsh_usage_lineDotHalo", cx: pts[lastIdx].x, cy: pts[lastIdx].y, r: "12" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { className: "dsh_usage_lineDot dsh_usage_lineDotLast", cx: pts[lastIdx].x, cy: pts[lastIdx].y, r: "4.5" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("title", { children: `${data[lastIdx].label}: ${intfmt(vals[lastIdx])}` })
    ] }),
